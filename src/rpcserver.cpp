...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BS features */
        {"BS", "masternode", &masternode, true, true, false},
        {"BS", "listmasternodes", &listmasternodes, true, true, false},
        {"BS", "getmasternodecount", &getmasternodecount, true, true, false},
        {"BS", "masternodeconnect", &masternodeconnect, true, true, false},
        {"BS", "masternodecurrent", &masternodecurrent, true, true, false},
        {"BS", "masternodedebug", &masternodedebug, true, true, false},
        {"BS", "startmasternode", &startmasternode, true, true, false},
        {"BS", "createmasternodekey", &createmasternodekey, true, true, false},
        {"BS", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"BS", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"BS", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"BS", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"BS", "getmasternodescores", &getmasternodescores, true, true, false},
        {"BS", "mnbudget", &mnbudget, true, true, false},
        {"BS", "preparebudget", &preparebudget, true, true, false},
        {"BS", "submitbudget", &submitbudget, true, true, false},
        {"BS", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"BS", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"BS", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"BS", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"BS", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"BS", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"BS", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BS", "checkbudgets", &checkbudgets, true, true, false},
        {"BS", "mnsync", &mnsync, true, true, false},
        {"BS", "spork", &spork, true, true, false},
        {"BS", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"BS", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
