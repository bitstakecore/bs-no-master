                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BS: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for xBS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BS Core"), this);
    aboutAction->setStatusTip(tr("Show information about BS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BS addresses"));
    ...
    openAction->setStatusTip(tr("Open a BS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BS Core help message to get a list with possible BS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BS network", "", count));
}
...
{
    QString strTitle = tr("BS Core"); // default title
