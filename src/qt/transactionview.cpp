 ...
 */
    ...
    typeWidget->addItem(tr("Received BS from xBS"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in xBS"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_xBS));
